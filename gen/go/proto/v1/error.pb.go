...
const file_error_proto_rawDesc = "" +
	...
	"\adetails\x18\x03 \x03(\v2\r.proto.v1.ErrR\adetails\"S\n" +
	"\tStrictErr\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x18\n" +
...
var file_error_proto_goTypes = []any{
	(*Err)(nil),       // 0: proto.v1.Err
	(*GRPCError)(nil), // 1: proto.v1.GRPCError
	(*StrictErr)(nil), // 2: proto.v1.StrictErr
}
var file_error_proto_depIdxs = []int32{
	0, // 0: proto.v1.GRPCError.details:type_name -> proto.v1.Err
